<template>
    <div>
        ...
        <div class="section">
            <div class="wrapper">
                <div class="wrap-box">
                    ...
                    <!--幻灯片-->
                    <div class="left-705">
                        <el-carousel :interval="5000" arrow="hover" height="341px">
        ...
        <div class="section" v-for="item in goods" :key="item.level1cateid">
            <div class="main-tit">
                <h2>{{item.catetitle}}</h2>
                <p>
                    <a href="/goods/43.html" v-for="subItem in item.level2catelist" :key="item.subcateid">{{subItem.subcatetitle}}</a>
